...
As our DeBerta model shows the best performance in terms of f1 score, we decided to perform qualitative analysis on that model. We define qualitative performance as: how does the true label of a tweet compare with the label predicted by DeBerta?

\subsection{True TC vs. Pred Non\_Informative (358 Total)}
We first look at tweets classified as \texttt{time\_critical} by the CrisisBench dataset, DeBerta 
...
\begin{table*}
    ...
    \begin{tabular}{|p{12cm}|c|}
        ...
        \hline
        @achohelelwhy: Update - Has Dementia! pls find him \#Missing \#Joplin Charles Writer (\url{http://on.fb.me/kHaGEY}) patient at \#Greenbrier ... & Actionable \\
        \hline
    \end{tabular}
    \end{center}
