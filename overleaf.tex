...
Because the dataset was consisted of tweets which have a character limit and lots of hashtags, there were rows with empty data after preprocessing that we had to throw out.
